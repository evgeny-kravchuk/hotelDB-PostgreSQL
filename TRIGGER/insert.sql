...
INSERT INTO "Tour" ("country","hotel","price","vise","flight","recall") VALUES
	('Germany',  true, 34554.99, true, 'Одесса - Киев','В этом туре вы сможете посетить монастырский Берлин'),
	('Polant',  true, 14569.99, true, 'Херсон - Стамбул','Здесь вы ощутите настоящую польскую душу'),
	('Ukraine',  true, 125699.99, false, 'Одесса - Киев','Столица Украины зачарует своей старинной историей'),
	('Egipt',  false, 125, false, 'Херсон - Стамбул','Глянем на монастырь'),
	('USA',  true, 1499.99, true, 'Одесса - Киев','Монастырская поездка'),
	('Australia',  true, 100500, true, 'Киев - Канбера','В этом туре вы сможете посетить стоилцу Австралии');
